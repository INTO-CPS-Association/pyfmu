...
from pyfmu.builder.export import extract_model_description
from .utils import get_example_project, ExampleArchive, get_all_examples


def test_extract_model_description():
    class Slave:
        def __init__(self):
            self.variables = []
    ...
    md = extract_model_description(s)
