...
#         must_be_defined = Fmi2ScalarVariable.should_define_start(
#             variability, causality, initial
#         )
...
#                 raise TypeError(
#                     f"Illegal combination of data type and start value. Type is {data_type} start is {start}."
#                 )

#         return None

#     @staticmethod
#     def should_define_start(
